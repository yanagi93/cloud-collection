...
func New(auth *service.AuthService, cloudPhotos *service.CloudPhotoService, processing *service.ProcessingService, animals *service.AnimalService, battles *service.BattleService) *Handler {
	return &Handler{
		auth:        auth,
